...
export function UniverseExamScreen({ visible, onClose }: Props) {
  ...
  const pal = useMemo(() => {
    ...
    return {
      ...
      headerTitleColor: Colors.dark.textHighEmphasis,
      headerAccentShadow: "rgba(8,14,28,0.70)",
      closeIcon: Colors.dark.textHighEmphasis,
      ...
      openChipText: Colors.dark.textHighEmphasis,
      doneBtn: Colors.dark.textMediumEmphasis,
