...
import { RingPlanetSvg, sphereRingsForScheme, sr } from "@/components/ring-planet";
...
// sphereRingsForScheme and SPHERE_RINGS imported from @/components/ring-planet
...
// sr, SPHERE_RINGS imported from @/components/ring-planet
...
// RingPlanetSvg imported from @/components/ring-planet
// Offset wrapper positions the PLANET_CANVAS-sized component within the SW-wide planetWrapper.
const RING_PLANET_OFFSET = -(PLANET_CANVAS - SW) / 2;
  ...
  return (
    <View style={[styles.cardContainer, { height: pageHeight }]}>
      <Animated.View style={[styles.planetWrapper, cardStyle]}>
        ...
        <View style={{ position: "absolute", left: RING_PLANET_OFFSET, top: RING_PLANET_OFFSET, width: PLANET_CANVAS, height: PLANET_CANVAS }} pointerEvents="none">
          <RingPlanetSvg id={card.id} colors={colors} ringRotation={rot} isLight={isLight} atmoR={ATMO_R} planetCanvas={PLANET_CANVAS} planetC={PLANET_C} />
        </View>
            ...
            <StarField
              ...
              nebulaColor={
                isLight
                  ...
                  : sphereRingsForScheme(activeCard?.sphere ?? "career", "dark").glow
              }
            />
            {!isLight
              ? twinkles.map((tw, i) => (
