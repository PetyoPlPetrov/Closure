...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'ai.placeholder.input': 'Tell a story or memory about someone from your sferas...',
  ...
  bg: {
    ...
    'insights.family.critical': 'Сферата на семейството ви се нуждае от спешно внимание. Фокусирайте се върху създаването на положителни спомени и укрепването на семейни връзки.',
    ...
    'ai.placeholder.input': 'Разкажете история или спомен за някой от вашите сфери...',
    ...
    'suggestions.anniversary.goodFacts.2': 'Научих какво наистина ценя във връзкита',
    'suggestions.anniversary.lessons.0': 'Равната инвестиция има значение във връзкита',
    ...
    'suggestions.money.lessons.0': 'Финансовите ценности трябва да се съвпадат във връзкита',
    ...
    'suggestions.colleague.goodFacts.2': 'Изграждам истински професионални връзки',
    'suggestions.colleague.lessons.0': 'Работните връзки трябва да бъдат професионални, а не лични',
    ...
    'suggestions.parent.lessons.2': 'Семейните връзки могат да се развиват и изцеляват',
    ...
    'suggestions.sibling.lessons.2': 'Здравите връзки изискват усилия от двете страни',
    ...
    'suggestions.manipulation.lessons.0': 'Манипулацията никога не е приемлива във връзкита',
    ...
    'suggestions.manipulation.lessons.4': 'Здравите връзки не включват манипулация',
    ...
    'suggestions.boundaries.lessons.0': 'Границите са от съществено значение за здрави връзки',
    ...
    'suggestions.criticism.lessons.4': 'Здравите връзки изграждат, а не разрушават',
    ...
    'suggestions.isolation.lessons.4': 'Здравите връзки насърчават външни връзки',
    ...
    'suggestions.possessiveness.lessons.4': 'Здравите връзки уважават индивидуалността',
    ...
    'suggestions.disrespect.lessons.4': 'Здравите връзки се изграждат върху уважение',
    ...
    'suggestions.narcissism.goodFacts.3': 'Мога да имам връзки с хора, които се грижат за мен',
    'suggestions.narcissism.goodFacts.4': 'Изграждам самооценка извън тях',
    'suggestions.narcissism.lessons.0': 'Заслужавам връзки, където имам значение',
    ...
    'suggestions.narcissism.lessons.4': 'Здравите връзки включват даване и взимане',
    ...
    'suggestions.codependency.lessons.1': 'Идентичността ми е отделна от връзкита',
    ...
    'suggestions.codependency.lessons.4': 'Здравите връзки включват два цели човека',
    ...
    'suggestions.redflags.lessons.4': 'Здравите връзки нямат големи червени знамена',
