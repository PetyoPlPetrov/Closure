...
export default function SettingsScreen() {
  ...
  const generateFakeData = async () => {
    ...
    try {
      ...
      const fakeProfiles = [
        {
          name: "Mark Johnson",
          description: "College sweetheart, first love",
        ...
        },
        {
          ...
          description: "Met at a coffee shop, instant connection",
          startDate: "2019-06-01",
          endDate: "2020-05-31",
        },
        {
          name: "James Wilson",
          description: "University classmate, shared interests",
      ...
      const fakeJobs = [
        {
          name: "Software Developer at TechCorp",
          description: "My first job in tech",
          startDate: "2020-03-01",
          endDate: "2022-06-30",
        },
        {
          name: "Senior Developer at StartupXYZ",
          description: "Fast-paced startup environment",
          startDate: "2022-07-01",
          endDate: "2023-12-31",
        },
        {
          name: "Lead Engineer at CurrentCompany",
          description: "Current role, growing my career",
          startDate: "2024-01-01",
          endDate: null,
          ongoing: true,
        },
        {
          name: "Junior Developer at WebSolutions",
          description: "Started my career journey here",
          startDate: "2019-01-15",
          endDate: "2020-02-28",
        },
        {
          name: "Full Stack Developer at DigitalAgency",
          description: "Creative projects and diverse clients",
      ...
      const fakeFamilyMembers = [
        {
          name: "Sarah Johnson",
          relationship: "Sister",
          description: "My older sister and best friend",
        },
        {
        ...
        },
        {
          name: "Maria Johnson",
          relationship: "Mother",
          description: "My loving mother",
        },
        {
          name: "Robert Johnson",
          relationship: "Father",
          description: "My supportive father",
        },
        {
          name: "Emily Johnson",
          relationship: "Sister",
          description: "My youngest sister",
        },
      ];
      ...
      const fakeFriends = [
        ...
        },
        {
          ...
          description: "Childhood friend, always there for me",
        },
        { name: "David Chen", description: "Work friend turned close friend" },
        { name: "Sophie Anderson", description: "Gym buddy and confidant" },
        {
          name: "Ryan Taylor",
          description: "High school friend, shared many adventures",
        },
        {
          name: "Maya Patel",
          description: "Book club friend, deep conversations",
        },
      ];
              ...
              try {
                ...
                for (let j = 0; j < numClouds; j++) {
                  hardTruths.push({
                    ...
                    text: cloudTexts[
                      Math.floor(Math.random() * cloudTexts.length)
                    ],
                ...
                for (let j = 0; j < numLessons; j++) {
                  lessonsLearned.push({
                    ...
                    text: lessonTexts[
                      Math.floor(Math.random() * lessonTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
      ...
      for (const jobData of fakeJobs) {
        try {
          ...
          const existingMemories = getIdealizedMemoriesByEntityId(
            jobId,
            "career",
          );
              ...
              try {
                ...
                for (let j = 0; j < numClouds; j++) {
                  hardTruths.push({
                    ...
                    text: careerCloudTexts[
                      Math.floor(Math.random() * careerCloudTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                for (let j = 0; j < numSuns; j++) {
                  goodFacts.push({
                    ...
                    text: careerSunTexts[
                      Math.floor(Math.random() * careerSunTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                // Use different memory titles for variety
                const memoryTitle =
                  careerMemoryTitles[i % careerMemoryTitles.length] +
                  ` (${i + 1})`;
                ...
                for (let j = 0; j < numLessons; j++) {
                  lessonsLearned.push({
                    ...
                    text: careerLessonTexts[
                      Math.floor(Math.random() * careerLessonTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
          ...
          if (existingMemories.length === 0) {
            ...
            for (let i = 0; i < numMemories; i++) {
              try {
                ...
                const cloudsFromRemaining =
                  remainingMoments - sunsFromRemaining;
                ...
                for (let j = 0; j < numClouds; j++) {
                  hardTruths.push({
                    ...
                    text: familyCloudTexts[
                      Math.floor(Math.random() * familyCloudTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                for (let j = 0; j < numSuns; j++) {
                  goodFacts.push({
                    ...
                    text: familySunTexts[
                      Math.floor(Math.random() * familySunTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                const memoryTitle =
                  familyMemoryTitles[i % familyMemoryTitles.length] +
                  ` (${i + 1})`;
                ...
                for (let j = 0; j < numLessons; j++) {
                  lessonsLearned.push({
                    ...
                    text: familyLessonTexts[
                      Math.floor(Math.random() * familyLessonTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
              ...
              try {
                ...
                for (let j = 0; j < numClouds; j++) {
                  hardTruths.push({
                    ...
                    text: friendsCloudTexts[
                      Math.floor(Math.random() * friendsCloudTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                for (let j = 0; j < numSuns; j++) {
                  goodFacts.push({
                    ...
                    text: friendsSunTexts[
                      Math.floor(Math.random() * friendsSunTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                const memoryTitle =
                  friendsMemoryTitles[i % friendsMemoryTitles.length] +
                  ` (${i + 1})`;
                ...
                for (let j = 0; j < numLessons; j++) {
                  lessonsLearned.push({
                    ...
                    text: friendsLessonTexts[
                      Math.floor(Math.random() * friendsLessonTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
              ...
              try {
                ...
                for (let j = 0; j < numClouds; j++) {
                  hardTruths.push({
                    ...
                    text: hobbiesCloudTexts[
                      Math.floor(Math.random() * hobbiesCloudTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                for (let j = 0; j < numSuns; j++) {
                  goodFacts.push({
                    ...
                    text: hobbiesSunTexts[
                      Math.floor(Math.random() * hobbiesSunTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
                ...
                const memoryTitle =
                  hobbiesMemoryTitles[i % hobbiesMemoryTitles.length] +
                  ` (${i + 1})`;
                ...
                for (let j = 0; j < numLessons; j++) {
                  lessonsLearned.push({
                    ...
                    text: hobbiesLessonTexts[
                      Math.floor(Math.random() * hobbiesLessonTexts.length)
                    ],
                    x: Math.random() * 300 + 50,
                    y: Math.random() * 400 + 50,
                  });
  ...
  const cleanupOrphanedMemoriesHandler = async () => {
    ...
    try {
      ...
      const message =
        cleanedCount > 0
          ? t("settings.devTools.cleanupMemories.success.withCount").replace(
              "{count}",
      ...
      Alert.alert(
        t("common.error"),
        t("settings.devTools.cleanupMemories.error"),
      );
    } finally {
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert(
                t("common.error"),
                t("settings.devTools.clearData.error"),
              );
            } finally {
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            style={[
              ...
              isDeletingData && { opacity: 0.5 },
              {
                ...
                borderWidth: 1,
                marginTop: __DEV__ ? 12 * fontScale : 0,
              },
            ]}
          ...
          >
            <View style={styles.dropdownContent}>
              ...
              >
                {isDeletingData
                  ? t("settings.devTools.clearData.deleting")
