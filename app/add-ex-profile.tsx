...
export default function AddExProfileScreen() {
  ...
  const [relationshipEndDate, setRelationshipEndDate] = useState<Date | null>(
    null,
  );
  ...
  const canSetAsOngoing =
    !hasExistingOngoingPartner ||
    (isEditMode && existingProfile?.relationshipEndDate === null);
  ...
  const hasChanges = useMemo(() => {
    ...
    const startDateStr = relationshipStartDate
      ? relationshipStartDate.toISOString().split("T")[0]
      : "";
    const endDateStr = isOngoing
      ? null
      : relationshipEndDate
        ? relationshipEndDate.toISOString().split("T")[0]
        : "";
  ...
  const hasUnsavedChanges = useCallback(() => {
    ...
    const currentStartDateStr = relationshipStartDate
      ? relationshipStartDate.toISOString().split("T")[0]
      : "";
    ...
    const currentEndDateStr = isOngoing
      ? null
      : relationshipEndDate
        ? relationshipEndDate.toISOString().split("T")[0]
        : "";
    const initialEndDateStr = initialIsOngoing.current
      ? null
                      ...
                      >
                        ...
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            if (
                              relationshipEndDate &&
                              currentStartDate > relationshipEndDate
                            ) {
                              Alert.alert(
                                t("common.error"),
                      ...
                      <DateTimePicker
                        ...
                        onChange={(event, selectedDate) => {
                          if (selectedDate) {
                            ...
                            if (
                              relationshipEndDate &&
                              selectedDate > relationshipEndDate
                            ) {
                              setRelationshipEndDate(null);
                            }
                          }
            ...
            {!isOngoing && (
              <View>
                ...
                >
                  <ThemedText size="l">
                    {relationshipEndDate
                      ? relationshipEndDate.toLocaleDateString("en-US", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                        })
                        ...
                        >
                          ...
                          <TouchableOpacity
                            onPress={() => {
                              ...
                              if (
                                relationshipStartDate &&
                                currentEndDate < relationshipStartDate
                              ) {
                                Alert.alert(
                                  t("common.error"),
                        ...
                        <DateTimePicker
                          ...
                          onChange={(event, selectedDate) => {
                            if (selectedDate) {
                              ...
                              if (
                                relationshipStartDate &&
                                selectedDate < relationshipStartDate
                              ) {
                                Alert.alert(
                                  t("common.error"),
                                  t("profile.date.error.endBeforeStart"),
